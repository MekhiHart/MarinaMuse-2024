...
function App() {
  ...
  const [isMobile, setIsMobile] = useState(window.innerWidth <= 650); // Check if screen is mobile size (650px)
  ...
  useEffect(() => {
    const handleResize = () => {
      setIsMobile(window.innerWidth <= 650); // Update mobile status based on screen width (650px)
    };
    ...
    <ThemeProvider theme={theme}>
      <div
        style={{
          ...
          backgroundImage:
            mode === "light"
              ? "url(http://localhost:3000/BackgroundLight.png)"
              : "url(http://localhost:3000/BackgroundDark.png)",
        }}
      >
        <SocketContext.Provider value={apiSocket}>
          {isMobile ? (
            ...
            >
              <NavBarMobile theme={theme} mode={mode}>
                <div
                  style={{
                    position: "flex",
                    bottom: "4.5vh",
                ...
                >
                  <div>
                    {!isMobile && ( // Render feedback form only if not on mobile
                      <div
                        style={{
                          marginBottom: "1.5vh",
                          display: "table",
                      ...
                      >
                        ...
                        >
                          <a
                            ...
                            href="https://forms.gle/MUCHvseSYHmyftvz9"
                          >
                            <svg
                              style={{
                                marginRight: "1.75vh",
                    ...
                    <div style={{ display: "flex" }}>
                      <span
                        style={{
                          ...
                          fontSize: "1.85vh",
                          marginRight: "2vh",
                          color: mode === "light" ? "#A3A8BF" : "#D6DDFF",
                        }}
                      >
                        Theme
                      </span>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <svg
                        style={{ marginRight: "1.75vh", marginTop: "-.25vh" }}
                        xmlns="http://www.w3.org/2000/svg"
                        width="2.15vh"
                        height="2.15vh"
                        viewBox="0 0 23 23"
